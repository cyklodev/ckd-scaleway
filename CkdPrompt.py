...
class CkdPrompt(Cmd):
    ...
    def updateprompt(self, int):
        ...
        if int == 1 :
            self.prompt = Fore.BLUE+'ckd-scaleway ['+Fore.RED+datacenter+Fore.BLUE+']# '+Style.RESET_ALL
        elif int == 0 :
            self.prompt = Fore.BLUE+'ckd-scaleway ['+Fore.GREEN+datacenter+Fore.BLUE+']# '+Style.RESET_ALL
        else:
            self.prompt = Fore.BLUE+'ckd-scaleway ['+Fore.YELLOW+datacenter+Fore.BLUE+']# '+Style.RESET_ALL
    ...
    def do_set_options(self,args):
        """Set the value of instanciate options"""
        global options
        global pp
        options =args
